    ...
    <div className="mx-auto max-w-6xl">
      ...
      {!searched && (
        <div className="mt-10 rounded-4xl border border-dashed border-gray-300 bg-gray-50 p-10 text-center">
          <Search className="mx-auto h-11 w-11 text-gray-400" />
      ...
      {searched && !isLoading && !error && results.length === 0 && (
        <div className="mt-10 rounded-4xl border border-dashed border-gray-300 bg-gray-50 p-10 text-center">
          <AlertCircle className="mx-auto h-9 w-9 text-gray-400" />
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2">
          {results.map((athlete) => {
            ...
            return (
              ...
              >
                <h2 className="text-xl font-bold text-gray-950">{athlete.full_name}</h2>
                ...
                <div className="mt-5 flex items-center gap-3">
                  <button
                    ...
                    className="inline-flex items-center gap-2 rounded-xl border border-gray-200 px-4 py-2.5 text-sm font-bold text-gray-700 transition hover:border-[#F0600E] hover:text-[#F0600E] disabled:cursor-not-allowed disabled:opacity-50"
                  >
